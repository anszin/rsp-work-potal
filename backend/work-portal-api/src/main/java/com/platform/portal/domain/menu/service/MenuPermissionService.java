...
public class MenuPermissionService {
    ...
    private static final List<Object[]> DEFAULTS = List.of(
        ...
        new Object[]{"work_units",       Map.of(User.Role.ADMIN, true, User.Role.MANAGER, true, User.Role.MEMBER, true,  User.Role.EXTERNAL, false)},
        new Object[]{"todos",            Map.of(User.Role.ADMIN, true, User.Role.MANAGER, true, User.Role.MEMBER, true,  User.Role.EXTERNAL, false)},
